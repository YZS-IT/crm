...
<script type="text/javascript">
	$(function (){
		...
		$('#saveBtn').click(function (){
			if ($.trim($('#create-dicTypeCode').val())=="" || $.trim($('#create-dicValue').val())==""){
				alert("字典类型编码和字典值不能空!")
				return
			}
			$.post("settings/dictionary/value/save.do",$('#createForm').serialize(),function (data) {
				if (data.success){
	...
	function getTypeCodeList(){
		$.get("settings/dictionary/value/getTypeCodeList.do",null,function (data) {
