    ...
    <div class="modal-dialog" role="document" style="width: 85%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="cancelBtn">关闭</button>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#addBtn").click(function (){
            ...
            $.get("workbench/activity/getUserList.do", null, function (data) {
                var html = "";
            ...
            // 操作模态窗口的方式：需要操作模态窗口的jquery对象，调用modal方法，该方法传递参数， show:打开模态窗口， hide：隐藏模态窗口
        ...
        $("#editBtn").click(function (){
            ...
            if ($xz.length==0){
                ...
                $.get("workbench/activity/getActivityAndUserList.do",{
                    id
                },function (data) {
                    //处理所有者下拉框
                    var html = ""
